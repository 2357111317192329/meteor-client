...
public class ElytraFly extends Module {
    ...
    public final Setting<Integer> lastelytraDurability = sgInventory.add(new IntSetting.Builder()
        ...
        .defaultValue(100)
        .range(2, Items.ELYTRA.getComponents().getOrDefault(DataComponentTypes.MAX_DAMAGE, 432))
        .sliderRange(2, Items.ELYTRA.getComponents().getOrDefault(DataComponentTypes.MAX_DAMAGE, 432))
